...
<template>
  <main
    class="h-screen flex flex-col bg-gradient-to-b from-amber-50 via-white to-white dark:from-zinc-950 dark:via-zinc-950 dark:to-black"
  >
    <TheHeader class="px-4 pt-4" />
