...
const defaultConfig = [
  { id: 1, name: '标识符混淆', value: 'renameIdentifier' },
  { id: 2, name: '字符串混淆', value: 'flowerCode' },
  { id: 3, name: '花指令', value: 'stringEncrypt' },
  { id: 4, name: '数值混淆', value: 'numericEncrypt' },
  { id: 5, name: '代码压缩', value: 'compact' },
  { id: 6, name: '移除注释', value: 'removeComments' },
]
const configList = reactive<Config[]>([...defaultConfig])

let nextId = ref(configList.length + 1)
